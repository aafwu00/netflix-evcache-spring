...
public class MemcachedHealthAutoConfiguration {
    ...
    public MemcachedClientFactoryBean memcachedClient(final InetUtils inetUtils, final EVCacheSidecarProperties properties) {
    ...
    @Bean
    @ConditionalOnProperty(value = "evcache.sidecar.health.eureka.enabled", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "evcache.sidecar.metrics.enabled", matchIfMissing = true)
    @ConditionalOnMissingBean
    ...
    @Bean
    @ConditionalOnProperty(value = "evcache.sidecar.health.memcached.enabled", matchIfMissing = true)
    @ConditionalOnMissingBean
