...
dependencies {
    compile 'com.github.aafwu00:netflix-evcache-spring:x.y.z' <2>
}
----
...
=== netflix-evcache-spring-boot-starter
...
dependencies {
    compile 'com.github.aafwu00:netflix-evcache-spring-boot-starter:x.y.z' <2>
}
----
<1> add `jitpack` repository
<2> add dependency
...
=== netflix-evcache-sidecar-spring-cloud-starter
...
dependencies {
    compile 'com.github.aafwu00:netflix-evcache-sidecar-spring-cloud-starter:x.y.z' <2>
}
----
<1> add `jitpack` repository
<2> add dependency
...
=== netflix-evcache-spring-cloud-starter
...
See on <<netflix-evcache-sidecar-spring-cloud-starter>>
...
dependencies {
    compile 'com.github.aafwu00:netflix-evcache-spring-cloud-starter:x.y.z' <2>
}
----
<1> add `jitpack` repository
<2> add dependency
