...
public class MemcachedHealthAutoConfiguration {
    ...
    public MemcachedClientFactoryBean memcachedClient(final InetUtils inetUtils, final EVCarProperties properties) {
    ...
    @Bean
    @ConditionalOnProperty(value = "evcar.health.eureka.enabled", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(value = "evcar.metrics.enabled", matchIfMissing = true)
    @ConditionalOnMissingBean
    ...
    @Bean
    @ConditionalOnProperty(value = "evcar.health.memcached.enabled", matchIfMissing = true)
    @ConditionalOnMissingBean
