...
@EnableConfigurationProperties(EVCarProperties.class)
public class EVCarAutoConfiguration {
    private final ConfigurableEnvironment env;
    private final EurekaInstanceConfigBean eurekaInstanceConfigBean;
    private final EVCarProperties properties;

    public EVCarAutoConfiguration(final ConfigurableEnvironment env,
                                  final EurekaInstanceConfigBean eurekaInstanceConfigBean,
                                  final EVCarProperties properties) {
    ...
    public HasFeatures evcarFeature() {
        return HasFeatures.namedFeature("EVCar", EVCarAutoConfiguration.class);
    }
