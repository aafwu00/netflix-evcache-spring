 ...
 * @author Taeho Kim
 */
class MemcachedHealthContributorAutoConfigurationTest {
    ...
    @Test
    void should_be_loaded_MemcachedHealthIndicator_when_exist_EnableEVCacheServer() {
        contextRunner.withUserConfiguration(EnableEVCacheServerConfiguration.class)
                     .run(context -> assertThat(context).hasSingleBean(MemcachedHealthIndicator.class));
    }

    @Test
    void should_be_not_loaded_MemcachedHealthIndicator_when_not_exists_EnableEVCacheServer() {
    ...
    @Test
    void should_be_loaded_MemcachedHealthIndicator_when_management_health_defaults_enabled_is_true() {
    ...
    @Test
    void should_be_not_loaded_MemcachedHealthIndicator_when_management_health_defaults_enabled_is_false() {
    ...
    @Test
    void should_be_loaded_MemcachedHealthIndicator_when_management_health_memcached_enabled_is_true() {
        contextRunner.withPropertyValues("management.health.defaults.enabled=false",
    ...
    @Test
    void should_be_not_loaded_MemcachedHealthIndicator_when_management_health_memcached_enabled_is_false() {
        contextRunner.withPropertyValues("management.health.defaults.enabled=true",
