...
public class EVCacheServerAutoConfiguration {
    ...
    public EVCacheServerAutoConfiguration(final ConfigurableEnvironment env,
    ...
    public HasFeatures evcacheServerFeature() {
        return HasFeatures.namedFeature("Netflix EVCache Server", EVCacheServerAutoConfiguration.class);
    }
