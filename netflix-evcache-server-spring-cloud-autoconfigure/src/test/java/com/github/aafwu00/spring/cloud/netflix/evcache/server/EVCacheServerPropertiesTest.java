...
@ContextConfiguration(classes = EVCacheServerPropertiesTest.Config.class, initializers = ConfigFileApplicationContextInitializer.class)
@DirtiesContext
class EVCacheServerPropertiesTest {
    @Autowired
    private EVCacheServerProperties properties;
